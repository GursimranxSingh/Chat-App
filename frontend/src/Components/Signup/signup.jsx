  ...
  const handleSubmit = (values, form) => {
    if (userData) {
      let userDetail = userData.find(
        (ele) =>
          ele.email === values.email && ele.phoneNumber === values.phoneNumber
      );
      if (userDetail) {
          ...
          <Col lg={4} md={6}>
            ...
            >
              <Row>
                ...
                <Form
                  ...
                  render={({ handleSubmit, error, values }) => (
                    <form onSubmit={handleSubmit}>
                      ...
                      <Col lg={12}>
                        <button className="signup-button mb-4" type="submit">
                          {" "}
                          SIGN UP
                        </button>
                      </Col>
                ...
                />
                <p className="c-a-account mb-2  "> Already have a account </p>
                <p className="no-acct mb-0" onClick={() => navigate("/")}>
                  SIGN UP
                </p>
              </Row>
            </div>
